                        ...
                        <div class="grid grid-rows-2">   
                          ...
                          <div>
                            <ul class="flex flex-row mb-5">
                                ...
                                <li  class="mr-10 "><a href="{{route('followers')}}">
                                    <span class="font-semibold">{{$profile->followers()->count()}}</span>{{__('followers')}}</a></li>
...
<hr class="mb-10">
            ...
            <div>
                ...
                <p class="text-center">{{__('Follow to see thier posts')}}</p>
            </div>
            @endcan
            @endif
            </div> 
